 ...
 */
final class Version20221208111655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restau (id INT AUTO_INCREMENT NOT NULL, nom_restau VARCHAR(50) NOT NULL, numero_telfn_restau INT DEFAULT NULL, adresse_restau VARCHAR(50) DEFAULT NULL, fax_restau INT DEFAULT NULL, image VARCHAR(255) NOT NULL, ville VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
